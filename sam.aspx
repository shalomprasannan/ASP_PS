<%@ Page Language="C#" AutoEventWireup="true" CodeFile="sam.aspx.cs" Inherits="PowerShellExecution.Default" %>
...
<form id="form1" runat="server">
    <div>
		...
		<asp:TextBox ID="Shal" runat="server" TextMode="MultiLine" Width="433px" Height="73px" ></asp:TextBox>
            </td></tr>
            <tr><td>
                &nbsp;</td><td>
